...
const Stakes = () => {
	...
	const {
		...
		abi: erc20Abi,
		contractAddress: MCC_TOKEN_ADDRESS,
	...
	const {
		...
		abi: erc20Abi,
		contractAddress: SMCC_TOKEN_ADDRESS,
		functionName: "balanceOf",
		params: {
			account: user?.get("ethAddress"),
		},
		...
		<div className="Stakes" style={{ marginTop: "3rem" }}>
			...
			<section className="amounts">
				...
				<div className="staked-balance balance">
					<Tooltip
						title="Staked $MCC. Required to play the game"
	...
	return (
		<>
			...
			<Modal
				...
				footer={null}
				closable={false}>
				<p>Staked MCC Check in progress...</p>
			</Modal>
			<Modal
				title="Loading"
				...
				footer={null}
				closable={false}>
				<p>MCC Balance Check in progress...</p>
			</Modal>
			<Modal
				title="Loading"
