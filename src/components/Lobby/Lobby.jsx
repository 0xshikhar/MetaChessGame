...
const Lobby = ({ setIsPairing, pairingParams, setPairingParams }) => {
	...
	function showGameConfirm() {
		confirm({
			...
			content: "By starting the game you bet 10 MCC in the pool.",
			okText: "Start Game",
			okType: "primary",
			cancelText: "Close",
			onOk() {
...
const openStakeErrorNotification = () => {
	notification["error"]({
		message: "Not Enough MCC Staked",
		description:
			"You have not staked enough $MCC to play. Please stake more $MCC in the staked tab to play.",
		placement: "bottomRight",
	});
};
